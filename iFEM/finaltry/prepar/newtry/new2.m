...
best_scale_interpolated_to_abaqus = ...
    dot(U_interpolated_compare(:), ...
        U_reference_compare(:)) / ...
    max(dot(U_interpolated_compare(:), ...
            U_interpolated_compare(:)), eps);

U_interpolated_scaled = ...
    best_scale_interpolated_to_abaqus * ...
    U_interpolated_compare;
...
fprintf('插值位移场范数：%.6e\n', ...
    norm(U_interpolated_compare, 'fro'));
